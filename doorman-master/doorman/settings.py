...
class Config(object):
    ...
    # given file.
    DOORMAN_LOG_FILE_PLUGIN_JSON_LOG = 'D:/doorman-master/log/doorman/osquery.log'     # Default: do not log status/results to json log
    DOORMAN_LOG_FILE_PLUGIN_STATUS_LOG = 'D:/doorman-master/log/doorman/status.log'     # Default: do not log status logs
    DOORMAN_LOG_FILE_PLUGIN_RESULT_LOG = 'D:/doorman-master/log/doorman/result.log'     # Default: do not log results
    ...
    DOORMAN_LOGGING_FILENAME = 'D:/doorman-master/log/doorman/doorman.log'
...
class ProdConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = 'postgresql://postgres:manager@localhost:5432/doorman'
